...
import type { ClientProject } from '../../../services/api/clientMockService';
import { ChevronLeft, Info, CheckCircle2, AlertCircle, FileText, Send, Upload, Star, MessageSquare } from 'lucide-react';
