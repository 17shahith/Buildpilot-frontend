...
// Import sub-views
import { ProfessionalOverview } from '../components/ContractorOverview';
import { FindProjects } from '../components/FindProjects';
import { ProProjects } from '../components/ContractorProjects';
import { ProProjectWorkspace } from '../components/ContractorProjectWorkspace';
import { ProProposals } from '../components/ContractorProposals';
import { ProClients } from '../components/ContractorClients';
import { ProSchedule } from '../components/ContractorSchedule';
import { ProEarnings } from '../components/ContractorEarnings';
import { ProDocuments } from '../components/ContractorDocuments';
import { ProPortfolio } from '../components/ContractorPortfolio';
import { ProProfile } from '../components/ContractorProfile';
import { ProSettings } from '../components/ContractorSettings';

// Import existing BuildPilot tools
import AIEstimator from '../../estimation/pages/AIEstimator';
import ARVisualizer from '../../ai/pages/ARVisualizer';
import AIInteriorStudio from '../../ai/pages/AIInteriorStudio';
